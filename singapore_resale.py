...
# Load data
data = pd.read_csv(r"C:\Users\Mohan.S\Desktop\Mohan_Project\Project6\dataset\Pricedata.csv")
...
def model_data():
   with open(r"C:\Users\Mohan.S\Desktop\Mohan_Project\Project6\resale_rfr.pkl",'rb') as files:
